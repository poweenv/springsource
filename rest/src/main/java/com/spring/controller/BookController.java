...
public class BookController {
	...
	// http://localhost:8080/1001 +GET : code가 1001번인 도서정보 조회
	...
	//http://localhost:8080/1001 +DELETE : code가 1001번이 도서 삭제
	...
	public ResponseEntity<String> update(@RequestBody BookDTO dto){
		log.info("도서정보 수정 "+dto.getCode()+","+dto.getPrice());
