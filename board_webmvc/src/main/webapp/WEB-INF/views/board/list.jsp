			...
			<div class="form-row">
				<div class="form-group col-3">
					<select name="type" id="type" class="form-control">
						...
						<option value="TC">제목 or 재용</option>
	...
	<tbody>
		<c:forEach var="dto" items="${list}">
			<tr>
				...
				<td><a href="/board/read?bno=${dto.bno}">${dto.title}</td>
				<td>${dto.writer}</td>
...
<nav aria-label="...">
	<ul class="pagination justify-content-center">
		...
		<c:if test="${pageDTO.prev}">
			<li class="page-item">
			<a class="page-link" href="${pageDTO.startPage-1} ">Previous</a></li>
		</c:if>
		...
		<c:if test="${pageDTO.next}">
			<li class="page-item">
			<a class="page-link" href="#" href="${pageDTO.endPage+1} ">Next</a></li>
		</c:if>
	</ul>
</nav>
